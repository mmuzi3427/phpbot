...
define('API_KEY', '8102506495:AAFYfLO1a1wytXSIrWPY1eWeYgZ4tBDHVew');
$Manager = "7151642135";
...
if ($chat_id != $Manager) {
    ...
    if(isset($reply_to_message)){
        ...
        bot('sendmessage', [ // maxsus bot funksiyamiz orqali sendmessage ga'chat_id' => $reply_chat_id, // bot qayta yuborgan habar id raqami va
